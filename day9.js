    ...
    function intCode() {
        ...
        for (let i = 0; copy.length; i++) {
            ...
            if (direction === 1 || direction === 2) {
                ...
                if (direction === 3) copy[c] = inputCode;
                else diagnostic = (param1 === 0 ? copy[copy[i]] : param1 === 1 ? copy[i] : copy[copy[i] + base]) || 0;
...
console.log(`Solution for part 1 is: ${solve(1)}`);
console.log(`Solution for part 2 is: ${solve(2)}`);